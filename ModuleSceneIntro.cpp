...
bool ModuleSceneIntro::Start()
{
	...
	CreateCube(3, 3, 100, Cian, 10000, -10, 1.5, 0, 0, { 0, 0, 0 }); // A  
	CreateCube(3, 3, 100, Black, 10000, 10, 1.5, 0, 0, { 0, 0, 0 });

	CreateCube(3, 3, 100, Black, 10000, -40, 1.5, 0, 0, { 0, 0, 0 }); // B  
	CreateCube(3, 3, 100, Cian, 10000, -60, 1.5, 0, 0, { 0, 0, 0 });

	CreateCube(3, 3, 14, Cian, 10000, -15, 1.5, 55, -45, { 0, 1, 0 }); // C1
	CreateCube(2, 3, 9, Black, 10000, -25, 1.5, 60, 90, { 0, 1, 0 }); // C2
	CreateCube(3, 3, 14, Cian, 10000, -35, 1.5, 55,  45, { 0, 1, 0 }); // C3

	CreateCube(3, 3, 22, Cian, 10000, 5, 1.5, 60, -26.56, { 0, 1, 0 }); // D1
	CreateCube(2, 3, 14, Black, 10000, -5, 1.5, 75, -45, { 0, 1, 0 }); // D2
	CreateCube(3, 3, 30, Cian, 10000, -25, 1.5, 80, 90, { 0, 1, 0 }); // D3
	CreateCube(2, 3, 14, Black, 10000, -45, 1.5, 75, 45, { 0, 1, 0 }); // D4
	CreateCube(3, 3, 22, Cian, 10000, -55, 1.5, 60, 26.56, { 0, 1, 0 }); // D1

	CreateCube(3, 3, 14, Cian, 10000, -15, 1.5, -55, 45, { 0, 1, 0 }); // E1
	CreateCube(2, 3, 9, Black, 10000, -25, 1.5, -60, 90, { 0, 1, 0 }); // E2
	CreateCube(3, 3, 14, Cian, 10000, -35, 1.5, -55, -45, { 0, 1, 0 }); // E3

	CreateCube(3, 3, 22, Cian, 10000, 5, 1.5, -60, 26.56, { 0, 1, 0 }); // F1
	CreateCube(2, 3, 14, Black, 10000, -5, 1.5, -75, 45, { 0, 1, 0 }); // F2
	CreateCube(3, 3, 30, Cian, 10000, -25, 1.5, -80, 90, { 0, 1, 0 }); // F3
	CreateCube(2, 3, 14, Black, 10000, -45, 1.5, -75, -45, { 0, 1, 0 }); // F4
	CreateCube(3, 3, 22, Cian, 10000, -55, 1.5, -60, -26.56, { 0, 1, 0 }); // F1
	...
	createcube(1.0f, 0.25f, 60.0f, vec3(0, 1, 0), 0, vec3(-33, 5, -51), Pink);//Bordes
	createcube(1.0f, 5.0f, 60.0f, vec3(0, 1, 0), 0, vec3(-33, 2.5, -51), White);//Bordes
	...
	createcube(18.5f, 0.25f, 1.0f, vec3(0, 0, 1), 30, vec3(-25.5, 9, -80.5), Pink);//Bordes
	createcube(18.0f, 5.0f, 1.0f, vec3(0, 0, 1), 30, vec3(-24, 7, -80.5), White);//Bordes
	...
	createcube(34.0f, 1.0f, 10.0f, vec3(0, 0, 1), 0, vec3(0, 8, -85.5), Black);//Puente
	...
	createcube(1.0f, 0.25f, 40.0f, vec3(1, 0, 0), 7.5, vec3(31, 3.5, -61), Pink);//Bordes
	createcube(1.0f, 6.0f, 40.0f, vec3(1, 0, 0), 7.5, vec3(31, 0.5, -61), White);//Bordes

	createcube(2.0f, 4.0f, 1.0f, vec3(1, 0, 0), 0, vec3(30, 1.5, -80.5), White);//Arreglo bajada
	createcube(3.0f, 4.0f, 1.0f, vec3(1, 0, 0), 0, vec3(-31.5, 1.5, -80.5), White);//Arreglo bajada

	createcube(40.0f, 0.25f, 1.0f, vec3(0, 1, 0), 25, vec3(22.5, 1, -25.5), Pink);//Bordes
	createcube(40.0f, 1.0f, 1.0f, vec3(0, 1, 0), 25, vec3(22.5, 0.5, -25.5), White);//Bordes
	...
	createcube(1.0f, 1.0f, 119.0f, vec3(1, 0, 0), 0, vec3(-26, 0.5, -80.5), White);//Bordes
	createcube(1.0f, 0.25f, 119.0f, vec3(1, 0, 0), 0, vec3(-26, 1, -80.5), Pink);//Bordes

	createcube(8.0f, 1.0f, 1.0f, vec3(0, 0, 1), -30, vec3(-29.5, 2.5, -21.5), White);//Bordes
	createcube(7.0f, 1.0f, 1.0f, vec3(0, 0, 1), -30, vec3(-30, 2, -21.5), White);//Bordes
	createcube(6.5f, 1.0f, 1.0f, vec3(0, 0, 1), -30, vec3(-30, 1.5, -21.5), White);//Bordes
	createcube(6.0f, 1.0f, 1.0f, vec3(0, 0, 1), -30, vec3(-30, 1, -21.5), White);//Bordes
	createcube(8.0f, 1.0f, 1.0f, vec3(0, 0, 1), 0, vec3(-29.5, 0.5, -21.5), White);//Bordes
	createcube(4.0f, 1.0f, 1.0f, vec3(0, 0, 1), 0, vec3(-30.5, 1.5, -21.5), White);//Bordes
	createcube(8.0f, 0.25f, 1.0f, vec3(0, 0, 1), -30, vec3(-29.5, 3, -21.5), Pink);//Bordes
	...
	createcube(1.0f, 1.0f, 15.0f, vec3(0, 1, 0), -45, vec3(-20.75, 0.5, -145), White);//Bordes
	createcube(1.0f, 0.25f, 15.0f, vec3(0, 1, 0), -45, vec3(-20.75, 1, -145), Pink);//Bordes
	...
	createcube(1.0f, 1.0f, 15.0f, vec3(0, 1, 0), 45, vec3(-0.75, 0.5, -145), White);//Bordes
	createcube(1.0f, 0.25f, 15.0f, vec3(0, 1, 0), 45, vec3(-0.75, 1, -145), Pink);//Bordes
	...
	createcube(1.0f, 1.0f, 10.0f, vec3(0, 1, 0), 90, vec3(-10.5, 0.5, -150), White);//Bordes
	createcube(1.0f, 0.25f, 10.0f, vec3(0, 1, 0), 90, vec3(-10.5, 1, -150), Pink);//Bordes
